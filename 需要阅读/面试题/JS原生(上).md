...
https://juejin.cn/post/6844903815053852685#heading-16
...
![img](media/JS原生/1-20210406220231925.jpeg)
...
**题难不难？不难！继续挑战一下！难！知道难，就更要继续了！** ![img](media/JS原生/169fc27e0fe8e59c-20210406220232030.gif)
...
![img](media/JS原生/1-20210406220231986.jpeg)
...
**看不下去了？别人的送分题会成为你的送命题** ![img](media/JS原生/1-20210406220231984.jpeg)
...
![img](media/JS原生/1-20210406220232028.jpeg)
...
promise的then实现，详见: [Promise源码实现](https://juejin.im/post/6844903796129136654)
...
promises 中所有的promise都“完成”时或参数中不包含 promise 时回调完成。 3. 如果参数中有一个promise失败，那么Promise.all返回的promise对象失败 4. 在任何情况下，Promise.all 返回的 promise 的完成状态的结果都是一个数组
...
如果想了解更多Promise的源码实现，可以参考我的另一篇文章：[Promise的源码实现（完美符合Promise/A+规范）](https://juejin.im/post/6844903796129136654#heading-24)
...
![img](data:image/svg+xml;utf8,<?xml%20version=%221.0%22?%3E%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20version=%221.1%22%20width=%22338%22%20height=%22300%22%3E%3C/svg%3E)

本文的写成耗费了非常多的时间，在这个过程中，我也学习到了很多知识，谢谢各位小伙伴愿意花费宝贵的时间阅读本文，如果本文给了您一点帮助或者是启发，请不要吝啬你的赞和Star，您的肯定是我前进的最大动力。[github.com/YvetteLau/B…](https://github.com/YvetteLau/Blog)
...
1. [www.ibm.com/developerwo…](https://www.ibm.com/developerworks/cn/web/1306_jiangjj_jsinstanceof/index.html)
2. [juejin.im/post/684490…](https://juejin.im/post/6844903798784131079#heading-0)
3. 选用了面试之道上的部分面试题
4. 选用了木易杨说文中提及的部分面试题: [juejin.im/post/684490…](https://juejin.im/post/6844903695411314696)
5. **特别说明**: `0.1 + 0.2 !== 0.3` 此题答案大量使用了此篇文章的图文: [juejin.im/post/684490…](https://juejin.im/post/6844903680362151950)
6. 选用了朋友面试大厂时遇到的一些面试题
7. 《你不知道的JavaSctipt》
8. 《JavaScript高级程序设计》
9. [github.com/hanzichi/un…](https://github.com/hanzichi/underscore-analysis/issues/20)