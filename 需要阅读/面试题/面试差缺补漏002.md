...
![image-20210202150514333](media/面试差缺补漏002/image-20210202150514333.png)
...
![图片懒加载](media/面试差缺补漏002/1737930fdf8ad3a1-20210202150256663.gif)图片懒加载
...
![Cookie](media/面试差缺补漏002/1-20210202150254402.png)Cookie
...
![Samesite](media/面试差缺补漏002/1-20210202150254404.png)Samesite
...
![同源策略](media/面试差缺补漏002/1-20210202150254268.png)同源策略
...
![image-20210202150331569](media/面试差缺补漏002/image-20210202150331569.png)
...
3. 觉得不错的话，也可以阅读TianTian近期梳理的文章（感谢掘友的鼓励与支持🌹🌹🌹）：
   - [「查缺补漏」送你 54 道 JavaScript 面试题](https://juejin.im/post/6854573211443544078)(410+👍)
   - [「算法与数据结构」链表的9个基本操作](https://juejin.im/post/6850418120755494925)(150+👍)
