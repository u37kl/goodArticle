...
![网页中z轴示意](media/009-层叠上下文/z-aris.png)
...
![层叠顺序](media/009-层叠上下文/2016-01-07_223349.png)
...
![疑问](media/009-层叠上下文/ask.gif)

为什么呢？我明明感觉浮动元素和块状元素要更屌一点啊。

嘿嘿嘿，我就不卖关子了，直接看下图的标注说明：
![层叠顺序元素的标注说明](media/009-层叠上下文/2016-01-07_235108.png)
...
![浮动和文字重叠](media/009-层叠上下文/2016-01-07_235830.jpg)
...
<img src="media/009-层叠上下文/image-20210119211040614.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119211352962.png" width=300>

大家会发现，尼玛反过来了，竖着的妹子(mm2)这回趴在了横着的妹子(mm1)身上。

为什么小小的改变会有想法的结果呢？
![思考](media/009-层叠上下文/think-2.gif)
...
<img src="media/009-层叠上下文/image-20210119211524052.png" width=300>



会发现，妹子跑到蓝色背景的下面了。为什么呢？层叠顺序图可以找到答案，如下：
![负值z-index的层叠顺序](media/009-层叠上下文/2016-01-08_235511.png)
...
<img src="media/009-层叠上下文/image-20210119211620047.png" width=300>



会发现，妹子在蓝色背景上面显示了，为什么呢？层叠顺序图可以找到答案，如下：
![img](media/009-层叠上下文/2016-01-08_235217.png)
...
<img src="media/009-层叠上下文/image-20210119211759717.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119211844396.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119212714181.png" width=500>
...
<img src="media/009-层叠上下文/image-20210119212745633.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119212928236.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119213100042.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119213214287.png" width=300>
...
![更完整的7阶层叠顺序图](media/009-层叠上下文/2016-01-09_211116.png)
...
<img src="media/009-层叠上下文/image-20210119213436931.png" width=300>
...
<img src="media/009-层叠上下文/image-20210119214206155.png" width=300>
...
![文字在妹子上](media/009-层叠上下文/2018-01-09_004641.png)

但是，一旦图片开始走fadeIn淡出的CSS3动画，文字跑到图片后面去了![img](media/009-层叠上下文/36.gif)：

![文字跑到图片后面](media/009-层叠上下文/2018-01-09_004654.png)
...
> 层叠上下文，是为了比较不同父元素的覆盖，
>
> stacking level(层叠等级)和stacking order很容易混淆，stacking order定义的是覆盖规则，而stacking level是覆盖等级，每个元素都有stacking level，根据规则算出自己的覆盖等级，覆盖等级小的会被覆盖。
>
> 误区：z-index不是stack level，上面说了stack level所有元素都有，而z-index只有特定的元素才有。
>
>  
>
> 比较两个元素覆盖等级：
...
![image-20210119222103536](media/009-层叠上下文/image-20210119222103536.png)
