...
![image-20210329090709541](media/TLS1.2_ECDHE/image-20210329090709541.png)

 

那么对于底数为 2 的时候， 32 的对数是 5，64 的对数是 6，计算过程如下：

![image-20210329090730472](media/TLS1.2_ECDHE/image-20210329090730472.png)
...
离散对数是在对数运算的基础上加了「模运算」，也就说取余数，对应编程语言的操作符是「%」，也可以用 mod 表示。离散对数的概念如下图：
 ...
 ![image-20210329090737718](media/TLS1.2_ECDHE/image-20210329090737718.png)
...
![image-20210329090753483](media/TLS1.2_ECDHE/image-20210329090753483.png)
...
![image-20210329090805344](media/TLS1.2_ECDHE/image-20210329090805344.png)
...
![image-20210329090816451](media/TLS1.2_ECDHE/image-20210329090816451.png)
...
![image-20210329090825416](media/TLS1.2_ECDHE/image-20210329090825416.png)
...
![image-20210329090836074](media/TLS1.2_ECDHE/image-20210329090836074.png)

 

这一步就和 RSA 握手过程有很大到区别了，因为服务端选择了 ECDHE 密钥协商算法，所以会在发送完证书后，发送「Server Key Exchange」消息。

![image-20210329091016420](media/TLS1.2_ECDHE/image-20210329091016420.png)
...
![image-20210329090845070](media/TLS1.2_ECDHE/image-20210329090845070.png)
...
![image-20210329091056083](media/TLS1.2_ECDHE/image-20210329091056083.png)
...
![image-20210329091108634](media/TLS1.2_ECDHE/image-20210329091108634.png)

 

接着，客户端会发「Encrypted Handshake Message」消息，把之前发送的数据做一个摘要，再用对称密钥加密一下，让服务端做个验证，验证下本次生成的对称密钥是否可以正常使用。

![image-20210329091114047](media/TLS1.2_ECDHE/image-20210329091114047.png)
...
————————————————
版权声明：本文为CSDN博主「Java秦心」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
