...
![image-20210202122543904](media/http1.1与http2.0对比/image-20210202122543904.png)
...
4. HTTPS可以有效的防止运营商劫持，解决了防劫持的一个大问题。
   ...
   ![image-20210202122555943](media/http1.1与http2.0对比/image-20210202122555943.png)
...
5. 服务端推送
   ...
   ![image-20210202122605922](media/http1.1与http2.0对比/image-20210202122605922.png)
...
![image-20210202122617211](media/http1.1与http2.0对比/image-20210202122617211.png)
...
- HTTP/2多个请求可同时在一个连接上并行执行。某个请求任务耗时严重，不会影响到其它连接的正常执行；
  ...
  ![image-20210202122629546](media/http1.1与http2.0对比/image-20210202122629546.png)
...
- 普通的客户端请求过程：
  ...
  ![image-20210202122642599](media/http1.1与http2.0对比/image-20210202122642599.png)

- 服务端推送的过程：

  ![image-20210202122649587](media/http1.1与http2.0对比/image-20210202122649587.png)
