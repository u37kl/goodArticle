...
![session.png](media/傻傻分不清之 Cookie、Session、Token、JWT/1-20210301223811690.png)
...
![img](media/傻傻分不清之 Cookie、Session、Token、JWT/1-20210301223811801.png)
...
![img](media/傻傻分不清之 Cookie、Session、Token、JWT/1-20210301223811816.png)
...
![img](media/傻傻分不清之 Cookie、Session、Token、JWT/1-20210301223811791.png)
...
![image.png](media/傻傻分不清之 Cookie、Session、Token、JWT/1-20210301223811793.png)
...
![img](media/傻傻分不清之 Cookie、Session、Token、JWT/1-20210301223811808.png)
...
[**一文彻底搞懂Cookie、Session、Token到底是什么**](https://juejin.im/post/6844904009061367821#heading-0)

**[3种web会话管理的方式](https://www.cnblogs.com/lyzg/p/6067766.html)！！！**

**[Token ，Cookie和Session的区别](https://www.cnblogs.com/JamesWang1993/p/8593494.html)！！！**
...
[**不要再使用MD5和SHA1加密密码了！**](https://blog.csdn.net/zhezhebie/article/details/71631077)
