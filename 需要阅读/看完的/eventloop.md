...
![browser-eventloop](media/eventloop/1460000016278118.png)
...
![node-libuv](media/eventloop/1460000016278119.png)

### NodeJS中的宏队列和微队列

NodeJS的Event Loop中，执行宏队列的回调任务有**6个阶段**，如下图：

![node-eventloop-6phase](media/eventloop/1460000016278120.png)
...
![node-eventloop](media/eventloop/1460000016278121.png)
...
![node-microtaskqueue](media/eventloop/1460000016278122.png)

![node-macrotaskqueue](media/eventloop/1460000016278123.png)
...
![node队列](media/eventloop/1460000022213423.png)