![彻底理解cookie，session，token](media/cookiesessiontoken/v2-9e50faf0b5c726db7d0cca5dff43ed5b_1440w.jpg)

# 彻底理解cookie，session，token

[![老刘](media/cookiesessiontoken/v2-fb5c24969a875712848caa7616fb9a6b_xs.jpg)](https://www.zhihu.com/people/xue-chuan-da-chong)
...
![img](media/cookiesessiontoken/v2-0820e192d7fed102203f131e5189cfb4_1440w.jpg)

后来有个叫Memcached的支了招： 把session id 集中存储到一个地方， 所有的机器都来访问这个地方的数据， 这样一来，就不用复制了， 但是增加了单点失败的可能性， 要是那个负责session 的机器挂了， 所有人都得重新登录一遍， 估计得被人骂死。

![img](media/cookiesessiontoken/v2-81c6a9f3edade4b8e276d182fb335704_1440w.jpg)
...
![img](media/cookiesessiontoken/v2-0d0a12e065ec8a09137d01192cce875f_1440w.jpg)

这个token 我不保存， 当小F把这个token 给我发过来的时候，我再用同样的HMAC-SHA256 算法和同样的密钥，对数据再计算一次签名， 和token 中的签名做个比较， 如果相同， 我就知道小F已经登录过了，并且可以直接取到小F的user id , 如果不相同， 数据部分肯定被人篡改过， 我就告诉发送者： 对不起，没有认证。

![img](media/cookiesessiontoken/v2-ed6c8498fd74cc60f16f897922ee040e_1440w.jpg)
...
![img](media/cookiesessiontoken/v2-26d5210a9c95c3a112372a12555118d4_1440w.jpg)
