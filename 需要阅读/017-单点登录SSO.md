...
![单点登录（SSO）设计](media/017-单点登录SSO/sso-system.png-kblb.png)
...
![SSO系统设计-登录时序图](media/017-单点登录SSO/sso-login-sequence.png-kbrb.png)
...
![SSO系统设计-登录信息获取/登录状态校验](media/017-单点登录SSO/sso-logincheck-sequence.png-kbrb.png)
...
![SSO系统设计-用户登出](media/017-单点登录SSO/sso-logout-sequence.png-kbrb.png)
...
![SSO系统设计-跨域登录（主域名已登录）](media/017-单点登录SSO/sso-crossdomain-login-loggedin-sequence.png-kbrb.png)

- 跨域登录（主域名未登录）

![SSO系统设计-跨域登录（主域名未登录）](media/017-单点登录SSO/sso-crossdomain-login-unlogin-sequence.png-kbrb.png)

- 跨域登出

![SSO系统设计-跨域登出](media/017-单点登录SSO/sso-crossdomain-logout-sequence.png-kbrb.png)
